...
import { StyledContainer, StyledTabContainer } from './Disclaimer.styled';
        ...
        <StyledContainer>
          <StyledTabContainer>
            ...
            <p>
              ...
              through this website, is for informational and educational
              purposes only.
            </p>
            <p>
            ...
            <p>
              ...
              employees, contributors, or other visitors to the site is solely
              at your own risk. Tinnitus is a complex condition, and individual
            ...
            <p>
              ...
              recommendation for use; always consult with your healthcare
              provider before starting any new supplement or treatment regimen,
              especially regarding potential interactions or safety.
            </p>
            <p>
            ...
            <p>
              ...
              go to the emergency department, or call emergency services (like
              911 in the US, 112 in Europe, or your local equivalent)
              immediately.
            </p>
          </StyledTabContainer>
        </StyledContainer>
