---
title: 'Tinnitus in Musicians: Why So Many Have It, and What Helps'
date: 'July 10, 2023'
description: 'Musicians and DJs face several times the tinnitus risk of the public. The data, the artists affected, and how to keep playing.'
image: '/images/musician.jpg'
tags: ['society', 'sounds']
faq:
  - question: 'How common is tinnitus among musicians?'
    answer: 'Musicians are roughly three times more likely to have tinnitus than the general public. A 2026 meta-analysis pooling 67 studies and more than 28,000 musicians found tinnitus in about 42.6% of musicians compared with 13.2% of non-musicians.'
  - question: 'Can you still be a musician with tinnitus?'
    answer: 'Yes. Many working musicians perform for years with tinnitus. The priorities are protecting your remaining hearing with musician earplugs or in-ear monitors, managing the distress and sleep disruption, and getting a hearing test so any hearing loss can be treated.'
  - question: 'What is the best hearing protection for musicians?'
    answer: 'Custom or high-fidelity musician earplugs, which lower the volume evenly across frequencies so the music still sounds natural, or in-ear monitors used at a safe level. Standard foam plugs work in a pinch but muffle the high frequencies musicians rely on.'
  - question: 'Does tinnitus after a loud concert go away?'
    answer: 'Often, yes. Temporary tinnitus and muffled hearing after loud exposure usually settle within hours to a couple of days as the ear recovers. Tinnitus that lasts more than about a week, or that follows repeated loud exposure, is more likely to be lasting and is worth a hearing check.'
sources:
  ...
  - title: "Auditory Symptoms Among Musicians: A Systematic Review and Meta-analysis"
    url: "https://pmc.ncbi.nlm.nih.gov/articles/PMC12860185/"
    publisher: "Otolaryngology-Head and Neck Surgery (2026)"
---
...
## <Highlighter>How common is tinnitus among musicians?</Highlighter>

Musicians are about three times more likely to have tinnitus than the general public. A 2026 systematic review in *Otolaryngology-Head and Neck Surgery*, pooling 67 studies and more than 28,000 musicians, found tinnitus in **42.6% of musicians versus 13.2% of non-musicians**, along with higher rates of hearing loss and [hyperacusis](/blog/hyperacusis-and-tinnitus). Risk was similar for classical and pop/rock players. Of the musicians with tinnitus, most described it as occasional rather than constant, but around one in six said it was permanent.

For musicians, DJs and sound engineers, the very thing that defines the craft is also the main threat to their hearing.
