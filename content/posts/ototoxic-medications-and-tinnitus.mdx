...
2) Document details. Note onset date, pitch (ring, hiss, cricket), loudness (0-10), which ear(s), and triggers (time of dose, caffeine, noise, sleep quality). A quick daily log in the app can help - try **/app** or explore tools in **[apps that help tinnitus](/blog/best-tinnitus-apps)**.
