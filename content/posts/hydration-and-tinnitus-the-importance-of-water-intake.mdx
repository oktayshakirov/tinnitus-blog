...
Your hydration needs vary based on your weight, activity level, and environment. Use this table to estimate your daily water intake:

| Body Weight      | Daily Water Intake (US) | Daily Water Intake (Metric) |
| ---------------- | ----------------------- | --------------------------- |
...
**Note:** These are base calculations. You may need to adjust based on your activity level and environment.
