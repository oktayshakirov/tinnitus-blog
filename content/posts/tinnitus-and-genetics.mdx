---
title: 'The Genetics of Tinnitus: What the Research Has Found'
date: 'August 19, 2023'
description: 'Twin studies, GWAS findings and the genes linked to tinnitus: the research behind whether tinnitus runs in families.'
image: '/images/genetics.jpg'
tags: ['research']
faq:
  - question: 'Is tinnitus hereditary?'
    answer: 'Partly. A large Swedish twin study found that genetics explains about 56% of the variation in tinnitus affecting both ears, but only about 27% for one-sided tinnitus. So bilateral tinnitus has a real hereditary component, while one-sided tinnitus is driven mostly by noise, injury or a local ear problem.'
  - question: 'Does tinnitus run in families?'
    answer: 'It can, especially when the tinnitus is in both ears. Family and twin studies show bilateral tinnitus clustering in relatives more than chance would predict. Shared environment and shared noise exposure also play a part, so a family pattern is not proof of a purely genetic cause.'
  - question: 'If my parent has tinnitus, will I get it?'
    answer: 'Not necessarily. A parent with bilateral tinnitus raises your risk somewhat, but tinnitus is multifactorial - many small genetic influences interacting with a lifetime of noise exposure and hearing changes. Protecting your hearing is the part of your risk you can actually control.'
  - question: 'Can a genetic test tell me if I will develop tinnitus?'
    answer: 'No. Research has found several genes linked to hearing and to tinnitus risk, but no single gene causes it and there is no clinically useful genetic test for tinnitus. Genetic findings so far are for research, not prediction or diagnosis.'
sources:
  ...
  - title: "Genetic susceptibility to bilateral tinnitus in a Swedish twin cohort"
    url: "https://pubmed.ncbi.nlm.nih.gov/28333916/"
    publisher: "Maas et al., Genetics in Medicine (2017)"
---
...
## **<Highlighter>Is tinnitus genetic?</Highlighter>**

Partly, yes - and it depends on the type. The largest study, using the Swedish Twin Registry (Maas and colleagues, *Genetics in Medicine*, 2017), estimated that **about 56% of the variation in bilateral tinnitus (both ears) is explained by genetics**, versus only 27% for one-sided tinnitus. Heritability was higher in men (68%) than women (41%). So tinnitus in both ears behaves partly like an inherited trait, while one-sided tinnitus is driven far more by environment - noise exposure, injury, or a local ear problem.

That does not mean a single "tinnitus gene." Like most common conditions it is multifactorial: many small genetic influences on the auditory system and stress response, interacting with a lifetime of noise exposure and [hearing loss](/blog/hearing-aids-and-tinnitus).
